...
class SendMessageController extends AdminController
{
	...
	{
		$dataProvider=new CActiveDataProvider('SendMessage');
	...
	{
		$model=new SendMessage('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['SendMessage']))
			$model->attributes=$_GET['SendMessage'];
	 ...
	 * @param SendMessage $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='send-message-form')
		{
