...
$('.search-form form').submit(function(){
	$('#template-type-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
		...
		array(
			'class'=>'CButtonColumn',
			'deleteConfirmation'=>"js:'你确定要删除【'+$(this).parent().parent().find('td:eq(1)').html()+'】吗？（该分类下的所有模板也会被删除）'"
		),
	),
)); ?>
